...
#-------------------------------------------------------------------------------------------------------------------------
# DOWNLOAD ScenarioMIP emissions data from the ixmp4 platform
#-------------------------------------------------------------------------------------------------------------------------
def _label(value):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--download_IAMC_region_R10", action="store_true", help="Download IAMC region data")
